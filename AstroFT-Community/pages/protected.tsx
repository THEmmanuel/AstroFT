...
export default function Protected(props) {
  ...
  return (
    <main className="container pb-12 h-screen m-auto pt-12 lg:pt-12">
      ...
      />
      <footer className="font-extrabold fixed text-white bottom-0 bg-black hover:bg-sky-700 left-0 w-full h-20 flex items-center justify-center">
        Made with the&nbsp;
        <a href="https://livepeer.com/docs/" className="text-livepeer text-xl">
          Livepeer.com
        </a>
        &nbsp;API &nbsp; &nbsp; &nbsp;
 Reset live stream here! &nbsp; &nbsp; &nbsp;
        <button
          className="text-white font-extrabold border p-2 h-3/4 rounded border-livepeer hover:bg-gray-300 hover:text-black"
